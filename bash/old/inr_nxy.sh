...
python3 experiments/inr_nxy.py "optim.batch_size=64" "optim.batch_size_val=64" "inr.latent_dim=256" "inr.hidden_dim=128" "inr.depth=5" "optim.lr_inr=5e-5" 'inr.w0=5' "data.data_to_encode=sdf" "inr.scale_factor=1" "inr.model_type=pos_embedder" 'inr.modulate_scale=False' 'optim.epochs=5000' 'optim.meta_lr_code=0' 'optim.weight_decay_code=0'  'inr.include_sdf=False'
